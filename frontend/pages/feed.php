...
<script src="/RedSocial_BUAP/frontend/js/feed.js?v=<?php echo filemtime(__DIR__ . '/../js/feed.js'); ?>"></script>
<script src="/RedSocial_BUAP/frontend/js/notifications.js?v=<?php echo filemtime(__DIR__ . '/../js/notifications.js'); ?>"></script>
<script src="/RedSocial_BUAP/frontend/js/websocket.js?v=<?php echo filemtime(__DIR__ . '/../js/websocket.js'); ?>"></script>
</body>
</html>
